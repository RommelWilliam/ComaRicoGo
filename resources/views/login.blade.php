...
<body class="flex justify-end w-screen h-screen min-h-screen bg-login_img bg-cover bg-no-repeat bg-right 
    ...
    <div class="w-2/5 h-full px-10 flex flex-col justify-center items-stretch rounded-s-2xl bg-white shadow-lg 
        ...
        <h2 class="text-2xl font-bold uppercase text-center mb-8 max-md:text-xl">¡BIENVENIDO A COMARICO GO!</h2>
        @if(session('error'))
        ...
        <form method="POST" action="{{ route('login.cliente') }}">
            @csrf
            <div class="flex justify-stretch border-2 border-gray-300 rounded-lg mb-5 p-2">
            ...
            <button type="submit" class=" w-full p-3 text-center uppercase bg-orange-500 rounded-lg text-white hover:bg-orange-600">Ingresar</button>
        </form>
    </div>
</body>
</html>